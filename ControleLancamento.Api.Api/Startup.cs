...
namespace ControleLancamento.Api.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(AppDomain.CurrentDomain.Load("ControleLancamento.Api.Application"));

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ControleLancamento.Api", Version = "v1" });
