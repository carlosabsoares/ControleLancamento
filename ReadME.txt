A API ControleLancamento foi contruida da seguinte forma:
	...
	* net 6 - Devido ser uma versão de suporte de longo tempo ainda pela microsoft;
	
	* Sqlite - Foi escolhido esse banco pela sua portabilidade e devido a sua criação ser um arquivo com final .db;
